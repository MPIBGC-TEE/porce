...
as aboveground biomass C (foliage + wood), belowground biomass C (fine and coarse roots),
...
`input` folder in this repository, and we can bind both curves as
...
respiration in the range: `r range(ER14_2019)`, with a mean value of `r mean(ER14_2019)`
and a median of `r median(ER14_2019)`.
